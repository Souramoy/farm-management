...
const Training: React.FC = () => {
      ...
      setContent([
        {
          ...
          type: 'video',
          description: 'Learn the fundamentals of monitoring animal health and identifying early warning signs',
          content: 'This comprehensive guide covers the essential aspects of animal health monitoring, including visual inspections, behavioral assessments, and key indicators to watch for in livestock.',
        ...
        },
        {
          ...
          type: 'article',
          description: 'Essential preventive care practices to maintain healthy livestock',
          content: 'Discover proven strategies for preventing disease outbreaks in your farm, including vaccination schedules, biosecurity measures, and environmental management.',
        ...
        },
        {
          ...
          type: 'guide',
          description: 'Step-by-step procedures for handling animal health emergencies',
          content: 'A detailed emergency response protocol covering immediate actions, veterinary contact procedures, and documentation requirements for various health emergencies.',
          thumbnail: 'https://images.pexels.com/photos/1108099/pexels-photo-1108099.jpeg',
          duration: '20 min'
        },
        {
          ...
          type: 'video',
          description: 'Maximize the effectiveness of AI-powered health scanning tools',
          content: 'Learn how to properly use AI scanning technology, interpret results, and integrate AI insights into your farm management practices.',
          thumbnail: 'https://images.pexels.com/photos/5212361/pexels-photo-5212361.jpeg',
          duration: '12 min'
        },
        {
          id: 5,
          ...
          type: 'article',
          description: 'Understanding regulatory requirements and documentation best practices',
          content: 'Comprehensive overview of compliance requirements, proper documentation methods, and maintaining accurate records for regulatory inspections.',
          thumbnail: 'https://images.pexels.com/photos/4386339/pexels-photo-4386339.jpeg',
          duration: '8 min'
        }
      ]);
    } finally {
  ...
  const markAsCompleted = (contentId: number) => {
    ...
    localStorage.setItem('trainingCompleted', JSON.stringify([...newCompleted]));
          ...
          <div className="glass-strong rounded-2xl p-6 mb-6">
            ...
            <div className="mb-6">
              <div className="flex items-center space-x-2 mb-2">
                ...
                <span className={`px-2 py-1 rounded border text-xs ${getTypeColor(selectedContent.type)}`}>
  ...
  const completedCount = content.filter(item => completedItems.has(item.id)).length;
  const progressPercentage = content.length > 0 ? Math.round((completedCount / content.length) * 100) : 0;
    ...
    <div className="min-h-screen p-4 pb-20">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-300">Enhance your farm management skills with expert guidance</p>
        </div>
              ...
              >
                <div className="relative">
                  ...
                  <div className="absolute top-3 left-3">
                    <span className={`px-2 py-1 rounded border text-xs ${getTypeColor(item.type)}`}>
        ...
        {content.length === 0 && (
          <div className="text-center py-12">
            ...
            <h3 className="text-xl font-semibold text-white mb-2">No training content available</h3>
            <p className="text-gray-400">Check back later for new training materials</p>
          </div>
        )}
      </div>
    </div>
